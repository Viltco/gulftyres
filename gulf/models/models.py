...
class GulfCostTyres(models.Model):
    ...
    def compute_shj_location(self):
        for k in self:
            ...
            for i in obj:
                print('vbnm')
                if i.location_id.location_id.name == 'Shj':
                    k.shj = i.inventory_quantity
                else:
                    k.shj
                    print('vbnm')
    ...
    def compute_shjsm_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'ShjSM':
                    k.shjsm = i.inventory_quantity
                else:
                    k.shjsm
    ...
    def compute_quz_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'Quz':
                    k.quz = i.inventory_quantity
                else:
                    k.quz
    ...
    def compute_ain_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'Ain':
                    k.ain = i.inventory_quantity
                else:
                    k.ain
    ...
    def compute_ainw_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'AinW':
                    k.ainw = i.inventory_quantity
                else:
                    k.ainw
    ...
    def compute_ajm_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'Ajm':
                    k.ajm = i.inventory_quantity
                    print('c', k.albr)
                else:
                    k.ajm
    ...
    def compute_albr_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'AlBr':
                    k.albr = i.inventory_quantity
                    print('b', k.albr)
                else:
                    k.albr
    ...
    def compute_ban_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'BAN':
                    k.ban = i.inventory_quantity
                    print(k.ban)
                else:
                    k.ban
    ...
    def compute_abu_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'ABU':
                    k.abu = i.inventory_quantity
                else:
                    k.abu
    ...
    def compute_abuold_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                print('pp', i.inventory_quantity)
                if i.location_id.location_id.name == 'ABUOL':
                    k.abuold = i.inventory_quantity
                else:
                    k.abuold
    ...
    def compute_mzr_location(self):
        for k in self:
            obj = self.env['stock.quant'].search([])
            for i in obj:
                if i.location_id.location_id.name == 'MZR':
                    k.mzr = i.inventory_quantity
                else:
                    k.mzr
